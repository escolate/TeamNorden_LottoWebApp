<div class="content-box">
    <a href="#" class="content-box-button red">! Spiel beenden</a>
    <h1>"Biergarten und Lotto" wird gerade gespielt...</h1>
	...
	<form name="events" class="action">
		...
		<tbody>
		    ...
		    <tr>
			<td><input type="checkbox"></td>
			<td><a href="#">Tobias Scheurer</a></td>
			<td><a href="#">30.10.2013</a></td>
		    </tr>
		    <tr>
			<td><input type="checkbox"></td>
			<td><a href="#">Mouna Agoulif</a></td>
